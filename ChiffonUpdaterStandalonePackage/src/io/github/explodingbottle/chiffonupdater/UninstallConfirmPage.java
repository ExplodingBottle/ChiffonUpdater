...
public class UninstallConfirmPage extends WizardPage {

	private static final long serialVersionUID = 6634789919648970293L;

	private JLabel messageLabel;

	private UninstallVersionSelectorPage versSelectPage;

	public UninstallConfirmPage(UninstallVersionSelectorPage versSelectPage) {
		this.versSelectPage = versSelectPage;
	...
	public void pageShown() {
		String selectedVersion = versSelectPage.getSelectedVersion();
		messageLabel.setText(PackageMain.getTranslator().getTranslation("uninstall.confirm.message", selectedVersion));
	}
