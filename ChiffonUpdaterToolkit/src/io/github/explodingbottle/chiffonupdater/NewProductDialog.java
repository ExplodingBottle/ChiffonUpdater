...
public class NewProductDialog extends JDialog implements ActionListener {
	...
	private ProductInfo mainInfos;

	private ToolkitWindow owner;

	public NewProductDialog(ToolkitWindow owner) {
		super(owner, "New product dialog", Dialog.ModalityType.APPLICATION_MODAL);
		...
		mainInfos = new ProductInfo(owner.getProject());

		editor = new ProductEditor(null, mainInfos);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == createProject) {
			owner.getProject().getProductsList().add(mainInfos);
